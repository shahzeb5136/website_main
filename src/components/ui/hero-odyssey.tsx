...
export const HeroOdyssey: React.FC<HeroOdysseyProps> = ({
  ...
  return (
    <div className="relative w-full bg-black text-white overflow-hidden min-h-[80vh]">
      {/* Content overlay */}
      <div className="relative z-20 w-full h-full flex flex-col items-center justify-center min-h-[80vh] px-4 sm:px-6 lg:px-8 py-20">
        {children}
      </div>
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/* Glowing circle */}
        <div className="absolute top-[55%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full bg-gradient-to-b from-amber-500/20 to-orange-600/10 blur-3xl"></div>
